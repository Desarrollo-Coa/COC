...
const formSchema = z.object({
  ...
  evento_critico: z.boolean().default(false),
...
export default function RegistrarNovedades() {
  ...
  useEffect(() => {
    ...
    fetchTiposEvento()
  }, [tipoReporteSeleccionado, form, toast])
  ...
  }, [negocioSeleccionado, form, toast])
  ...
  useEffect(() => {
    ...
    fetchPuestos()
  }, [unidadNegocioSeleccionada, form, toast])
  ...
  const onSubmit = async (data: z.infer<typeof formSchema>) => {
    try {
      ...
      toast({
        variant: "destructive",
        title: "Error",
        description: error instanceof Error ? error.message : "Error al registrar la novedad. Por favor, intente nuevamente.",
      })
    } finally {
      setLoading(false)
    }
