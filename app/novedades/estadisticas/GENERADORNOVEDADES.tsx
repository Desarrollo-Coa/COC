...
export default function EstadisticasPage() {
  ...
  // Remover esta verificación - el middleware ya maneja la protección
  // if (!isAuthenticated) {
  //   return null
  // }
  ...
  return (
    <div className="container mx-auto h-screen">
      {/* BOTÓN TEMPORAL PARA GENERAR NOVEDADES FALSAS */}
      <div className="flex justify-end mt-4">
        <button
          className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded shadow"
          onClick={() => setModalOpen(true)}
        >
          Generar novedades aleatorias (PRUEBA)
        </button>
      </div>
      <GeneradorNovedadesModal open={modalOpen} onOpenChange={setModalOpen} />
